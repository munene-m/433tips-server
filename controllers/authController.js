...
const registerUser = asyncHandler(async (req, res) => {
  const { username, email, password, confirmPassword, country, paid,supreme } = req.body;
  ...
  const registerAdmin = asyncHandler(async (req, res) => {
    const { username, email, password, confirmPassword, country, paid, isAdmin, supreme } = req.body;
...
//   })]
  ...
  module.exports = { registerUser, registerAdmin, loginUser, updateUser, reset, getUsers, getUser, deleteUser, getVipUsers,getCredentials }